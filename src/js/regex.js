...
function validateName(username) {
  if (username == "" || username == null) {
    document.getElementById("userInput").classList.add("border-red-600");
    ...
    if (!regex.test(username)) {
      ...
      document.getElementById("userInput").classList.remove("border-red-600");
      printError("userErr", "");
      return true;
    }
  }
...
function validateRepeat(password, repeat) {
  if (repeat == "" || repeat == null) {
    document.getElementById("repeatInput").classList.add("border-red-600");
    ...
    if (password != repeat) {
      ...
      document.getElementById("repeatInput").classList.remove("border-red-600");
