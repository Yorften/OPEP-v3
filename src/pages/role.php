...
<body>
    ...
    <div class="flex justify-center my-12">
        <div class="mx-auto w-1/2 bg-white border border-black rounded-xl">
            <form class="flex flex-col justify-around w-3/4 mx-auto h-[475px]" method="post">
                <div class="self-center">
                    <p class="text-center text-2xl">Pick your role</p>
                </div>
                <div class="flex flex-col justify-center items-center md:flex-row">
                    <div class="m-16">
                        <input type="radio" id="client-choice" name="user-choice" class="peer hidden" value="client" />
                        <label for="client-choice" class="flex flex-col gap-4 items-center select-none rounded border-2 px-8 py-4 font-bold transition-colors duration-200 ease-in-out peer-checked:border-amber-600 peer-checked:text-amber-600 md:w-[150px]">
                            <svg class="fill-current" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="_x32_" viewBox="0 0 512 512" xml:space="preserve">
                                <g>
                    ...
                    <div class="m-16">
                        <input type="radio" id="admin-choice" name="user-choice" class="peer hidden" value="admin" />
                        <label for="admin-choice" class="flex flex-col gap-4 items-center select-none rounded border-2 pl-8 pr-6 py-4 font-bold transition-colors duration-200 ease-in-out peer-checked:border-amber-600 peer-checked:text-amber-600 md:w-[150px]">
                            <svg class="fill-current peer-checked:text-amber-600" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="_x32_" viewBox="0 0 512 512" xml:space="preserve">
                ...
                <div class="flex justify-end mb-4">
                    <input type="submit" name="submit" class="cursor-pointer px-8 py-2 bg-[#9fff30] font-semibold rounded-lg border-2 border-[#6da22f]" value="Sign Up">
                </div>
            </form>
