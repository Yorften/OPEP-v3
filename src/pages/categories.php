...
require_once '../includes/CategoriesM.php';
    ...
    <div class="flex flex-col justify-end items-start h-[100vh]">
        ...
        <table class="table-fixed w-full ">
            ...
            <tbody>';
                ...
                ?>
                        <tr>
                            <td class="px-4 py-2 border-2 border-[#A3A3A3] text-xs md:text-base text-center"><?= $category1->getId() ?></td>
                            <td id="category<?= $category1->getId() ?>" class="px-4 py-2 border-2 border-[#A3A3A3] text-xs md:text-base text-center"><?= $category1->getName() ?></td>
