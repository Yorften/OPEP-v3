...
<body>
    ...
    ?>
    <div class="flex flex-col gap-6 justify-evenly mx-auto mt-12 mb-[15.5vh] md:flex-row">
        <div class="flex flex-col gap-1 h-full border-2 border-gray-400 rounded-md p-3 w-[95%] mx-auto md:w-[40%]">
            ...
            <?php if ($rows === 0) { ?>
                ...
                foreach ($Items as $item1) {
                    ...
                    <div class="flex flex-col relative border-2 border-gray-400 w-full md:min-h-[140px] rounded-md mb-2">
                        <div class="flex items-center justify-end w-full bg-[#19911D] h-4 rounded-tl-[4px] rounded-tr-[4px]">
                        </div>
                        <div class="flex md:flex-row items-center justify-between md:gap-2">
                            ...
                            <div class="flex h-full flex-col justify-center items-center gap-4 p-1 lg:p-0 lg:flex-row">
                                ...
                                <div class="flex flex-col justify-between items-end h-full gap-2 md:pr-2 md:py-2">
                                    <form method="POST" class="flex flex-col justify-center items-end md:justify-between md:items-end h-full gap-2 md:pr-2 md:py-2">
        ...
        <div class="flex flex-col gap-1 h-full border-2 border-gray-400 rounded-md p-3 w-[95%] mx-auto md:w-[40%]">
            ...
            if ($rows2 === 0) { ?>
                ...
                foreach ($Items2 as $item2) {
                    ...
                    $plant_cartId = $item2->getPlant_CartId();
                    $plantPrice = $plantPrice * $quantity;
                    $totalPrice2 = $totalPrice2 + $plantPrice ?>
                    <div class="flex flex-col relative border-2 border-gray-400 w-full md:min-h-[140px] rounded-md mb-2">
                        <div class="flex items-center justify-end w-full bg-[#19911D] h-4 rounded-tl-[4px] rounded-tr-[4px]">
                        </div>
                        <div class="flex gap-2 md:flex-row items-center justify-between">
                            <img class="object-contain h-[124px]" src="../images/Plants/<?= $plantImage ?>" alt="">
